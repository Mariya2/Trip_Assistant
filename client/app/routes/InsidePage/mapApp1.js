...
travelAssistant.controller('MapCtrl', ['$scope', '$rootScope', 'userService', '$timeout', 
                                       function($scope, $rootScope, userService, $timeout) {
...
*/
		...
		$scope.saveRoute = function() {
			...
			$scope.discardRoute = function(){
				...
				$scope.electedOptionStart = null;
				$scope.selectedAttractions.place_of_worship
				$scope.selectedAttractions.place_of_worship
				$scope.selectedAttractions.place_of_worship
				$scope.selectedAttractions.place_of_worship
			}
